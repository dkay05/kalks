        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: 'rgba(255,255,255,0.6)' }}>
              ...
              <li><Link href="/accounts/demo" className="hover:text-[#E12019] transition-colors">Demo Account</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: 'rgba(255,255,255,0.6)' }}>
              ...
              <li><Link href="/products/ib-referral" className="hover:text-[#E12019] transition-colors">Partnerships</Link></li>
            </ul>
          </div>
