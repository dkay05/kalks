...
import { BRAND_COPYRIGHT, BRAND_NAME, BRAND_LOGO_REVERSED } from '@/lib/brand';
...
export default function SharedTradePage() {
  ...
  return (
    ...
    >
      {/* Header logo — page background is always dark, so it takes the white mark. */}
      <div className="flex items-center mb-8">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={BRAND_LOGO_REVERSED} alt={BRAND_NAME} className="h-7 w-auto object-contain" />
      </div>
