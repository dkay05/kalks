...
export default function LandingLayout({ children }: { children: React.ReactNode }) {
  ...
  // Pages built on the homepage design system bring their own header and
  // footer, so the legacy landing chrome is skipped for them.
  const isHome = pathname === '/' || pathname === '/markets' || pathname === '/account-types'
