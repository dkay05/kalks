...
import { BRAND_NAME, BRAND_LOGO_REVERSED } from '@/lib/brand';
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex flex-col p-6 md:p-8">
        {/* Header logo — the card is always dark, so it takes the white mark. */}
        <div className="flex justify-center pt-2 pb-3">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={BRAND_LOGO_REVERSED} alt={BRAND_NAME} className="h-5 w-auto object-contain" />
        </div>
