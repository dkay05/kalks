            ...
            <article key={p.id} className="mk-card mk-card--hover overflow-hidden flex flex-col" style={{ padding: 0 }}>
              ...
              <div className="flex flex-col gap-3 flex-1" style={{ padding: 'var(--mk-space-5)' }}>
                ...
                <a
                  ...
                  aria-label={`Get ${p.title} by email`}
                >
                  <Download size={16} /> Get this guide
                </a>
              </div>
            </article>
          ))}
      ...
      <Section id="gate">
        <div className="mk-card grid md:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col gap-3">
            ...
            {subscribed && <p className="mk-body" role="status" style={{ color: 'var(--mk-accent)', fontWeight: 700 }}>Thanks, you&apos;re on the list. The guides are on their way to your inbox.</p>}
            <p className="mk-lead">
